...
export const courseDays: DayInfo[] = [
  ...
  },
  {
    ...
    schedule: [
      ...
      { start: "00:55", end: "01:15", title: "MUST 1–3 / NICE up to 2", minutes: 20 },
      { start: "01:15", end: "01:25", title: "Break", minutes: 10 },
      { start: "01:25", end: "01:50", title: "Wireframe and Project Brief", minutes: 25 },
      { start: "01:50", end: "02:10", title: "Plan review", minutes: 20 },
      { start: "02:10", end: "02:50", title: "v0 Project Studio", minutes: 40 },
  ...
  },
  {
    ...
    outcome: "Map the generated code, build one reviewed slice, and leave a safe handoff.",
    ...
    schedule: [
      ...
      { start: "00:30", end: "00:50", title: "Event, handler, state, render, screen", minutes: 20 },
      ...
      { start: "01:30", end: "01:40", title: "Review one slice", minutes: 10 },
  ...
  },
  {
    ...
    schedule: [
      ...
      { start: "01:40", end: "01:50", title: "Review the fix plan", minutes: 10 },
      { start: "01:50", end: "02:45", title: "Project Studio", minutes: 55 },
      { start: "02:45", end: "03:00", title: "Backup and demo path", minutes: 15 },
    ],
  },
  {
    day: 6,
