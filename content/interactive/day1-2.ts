...
export const day1Plan: InteractiveDayPlan = {
  ...
  stages: [
    ...
    },
    {
      ...
      completion: "The learner records one human decision and orders all five loop steps.",
      activities: [
        {
          id: "day1-demo-watch",
          kind: "watch",
          title: "Watch for the loop",
          instruction: "Mark each step when you see it in the demo.",
          items: ["TELL", "WATCH", "CHECK", "FIX", "SAVE"],
          minimum: 5,
        },
        {
          id: "day1-demo-human-decision",
          kind: "short-answer",
          title: "Name one human decision",
          instruction: "Write one choice the person made during the demo.",
          placeholder: "The person decided to...",
          minimum: 1,
        },
      ],
    },
    {
      ...
      completion: "The learner answers both responsibility choices and writes one testable success statement.",
      activities: [
        {
          id: "day1-role-choice",
          kind: "choice",
          ...
          options: [
            ...
            {
              label: "AI, because it wrote the code",
              value: "ai-decides",
              feedback: "Try again. The person must test the result.",
            },
            {
              label: "No one needs to check",
              value: "no-check",
              feedback: "Try again. Working code needs observable evidence.",
            },
          ],
        },
        {
    ...
    },
    {
      ...
      completion: "index.html opens with the required text, card, button, and click message.",
      activities: [
        {
        ...
        },
        {
          ...
          items: [
            "The title and card are visible.",
  ...
  stages: [
    {
      ...
      completion: "The learner orders all five steps and records one passing or failing Day 1 test.",
      activities: [
        {
          id: "day2-loop-order",
          kind: "short-answer",
    ...
    },
    {
      ...
      completion: "The learner writes a four-part Context Handoff with one real test record.",
      activities: [
        {
          id: "day2-handoff-read",
          kind: "read",
          title: "Four parts of a handoff",
        ...
        },
        {
          ...
          instruction: "Write one line for each part.",
          placeholder: "Current... Already works... Evidence... Next...",
          minimum: 4,
        },
        {
